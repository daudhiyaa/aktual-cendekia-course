...
if(isset($_POST['update_now'])){
   ...
   $update_box = filter_var($update_box, FILTER_UNSAFE_RAW);
...
<body>
   ...
   <?php
      if(isset($_POST['edit_comment'])){
         ...
         $edit_id = filter_var($edit_id, FILTER_UNSAFE_RAW);
   ...
   ?>
      <section class="edit-comment">
         ...
         <form action="" method="post">
            ...
            <textarea name="update_box" class="box" maxlength="1000" required placeholder="Please Enter Your Comment" cols="30" rows="10">
               <?= $fetch_edit_comment['comment']; ?>
            </textarea>
            <div class="flex">
