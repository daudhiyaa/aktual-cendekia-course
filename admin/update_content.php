...
if(isset($_POST['update'])){
   ...
   $playlist = filter_var($playlist, FILTER_UNSAFE_RAW);
   ...
   $old_thumb = filter_var($old_thumb, FILTER_UNSAFE_RAW);
   $thumb = $_FILES['thumb']['name'];
   $thumb = filter_var($thumb, FILTER_UNSAFE_RAW);
   ...
   $old_video = filter_var($old_video, FILTER_UNSAFE_RAW);
   $video = $_FILES['video']['name'];
   $video = filter_var($video, FILTER_UNSAFE_RAW);
