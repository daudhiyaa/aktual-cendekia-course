...
if(isset($_POST['submit'])){
   ...
   $old_image = filter_var($old_image, FILTER_UNSAFE_RAW);
...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>PLYLIST THUMBNAIL<span>*</span></p>
      <div class="thumb">
   ...
   <?php
      ...
      echo '<p class="empty">NO PLAYLIST ADDES YET!</p>';
   }
   ?>
</section>
